...
% ---------- Title info ----------
\title{UK Higher Education Levels, Awards, and Regulatory Oversight for\\
Transnational Delivery with Sri Lankan Partners}

\author{%
  Rukman Bernard Fernando Pulle\,\orcidlink{0009-0001-2737-8367}\\[0.5ex]
...
\input{sections/03_results_levels.tex}
\input{sections/04_results_governance.tex}
...
\input{sections/08_references_docid.tex}

\appendix

\input{sections/09_appendices.tex}
\input{sections/10_protocol.tex}
